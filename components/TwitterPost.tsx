...
export default function TwitterPost() {
  ...
  const handleGenerate = async () => {
    try {
      ...
      const response = await axios.post('/api/twitter/generate', { post, behaviour, words });
    ...
    <main className="flex flex-col space-y-8 pt-10">
      <div className='flex flex-col items-center justify-center gap-2'>
        ...
        <p className="text-sm text-neutral-500 max-w-lg text-center">
          Create engaging and professional Twitter posts effortlessly with SnipAI, your smart AI-powered writing assistant.
        </p>
      </div>
